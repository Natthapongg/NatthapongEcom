            ...
            <div className="col-lg-4">
              <div className="product-offer mb-30" style={{ height: 200 }}>
                ...
                <div className="offer-text">
                  <h6 className="text-white text-uppercase">โปรโมชั่นลด 20%</h6>
                  <h3 className="text-white mb-3">ข้อเสนอสุดพิเศษ</h3>
